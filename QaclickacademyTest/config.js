...
exports.config = {
	...
	// You can also comment the following line and still run the tests, it will
	// starting the server automatically BUT
	...
	suites : {
		smoke : [ 'sendKeysMouseMove&usingObjectClass.js', 'spec01.js',
				'shop.js' ],
		regression : 'shop.js'
	}
};
